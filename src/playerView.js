...
export function PlayerView(props) {
  ...
  const player = props.player.data
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <th>Ultimates</th>
              <td>
                {Math.round(player.stats.all.ultimates_earned_avg_per_10m)}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {Math.round(
                  player.stats.heroes[0].stats.final_blows_avg_per_10m
                )}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                {Math.round(
                  player.stats.heroes[0].stats.hero_damage_avg_per_10m
                )}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>Ultimates</th>
              <td>
                {Math.round(player.statRanks.ultimates_earned_avg_per_10m)}
              </td>
            </tr>
            <tr>
              <th>Final Blows</th>
